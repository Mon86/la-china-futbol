...
class Box
{
	...
	public function prepare()
	{
        ...
        $this->box->settings = [
            'trigger'              => (is_string($this->box->params->get('triggermethod'))) && array_key_exists($this->box->params->get('triggermethod'), $trigger_point_methods) ? $trigger_point_methods[$this->box->params->get('triggermethod')] : $this->box->params->get('triggermethod'),
            'trigger_selector'     => $this->box->params->get('triggerelement'),
            'delay'                => $this->box->params->get('triggermethod') === 'floatingbutton' ? 0 : (int) $this->box->params->get('triggerdelay') * 1000,
