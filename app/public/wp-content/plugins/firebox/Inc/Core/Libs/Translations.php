...
class Translations
{
	...
	public function getTranslations()
	{
		return [
			...
			'FB_SETTINGS_ANALYTICS_DESC' => __('Log the events of your campaigns to the database. This option is required for the Opening Behavior > Show Frequency feature to work properly.', 'firebox'),
			...
			'FB_SETTINGS_GAID_DESC' => __('Your Google Analytics Tracking ID: G-XXXXXXXX.', 'firebox'),
			...
			'FB_CAMPAIGN_RESET_STATS' => __('Campaign statistics has been reset.', 'firebox'),
			...
			'FB_ANALYTICS_TOP_DESC' => __('View and analyze the performance of your campaigns.', 'firebox'),
			...
			'FB_IMPORT_CAMPAIGNS' => __('Import Campaigns', 'fpf-framework'),
			'FB_PUBLISH_CAMPAIGNS' => __('Publish Campaigns', 'fpf-framework'),
			'FB_CLASSIC_POPUP' => __('Classic Popup', 'fpf-framework'),
			'FB_UNTITLED_CAMPAIGN' => __('Untitled Campaign', 'fpf-framework'),
		];
	}
}