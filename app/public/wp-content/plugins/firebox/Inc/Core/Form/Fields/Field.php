...
class Field
{
	...
	public function __construct($options = [])
	{
		...
		// Then override it based on defaul toptions, given options and field options
		$this->options = array_merge($this->getDefaultOptions(), $this->options, $this->getFieldOptions());
	}
