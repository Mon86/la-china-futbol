...
class Firebox extends Cpt
{
	...
	public function handle_bulk_actions($redirect_to, $action, $post_ids)
	{
		...
		else if ($action == 'reset_stats')
		{
			...
			\FPFramework\Libs\AdminNotice::displaySuccess(firebox()->_('FB_CAMPAIGN_RESET_STATS'));
		}
	...
	public function addExtraColumnsValues($column, $post_id)
	{
		switch ($column)
		{
			...
			case 'impressions':
				...
				?>
				<span class="fpf-badge info" title="<?php echo esc_attr(sprintf(firebox()->_('FB_CAMPAIGN_TOTAL_IMPRESSIONS'), $impressions)); ?>">
