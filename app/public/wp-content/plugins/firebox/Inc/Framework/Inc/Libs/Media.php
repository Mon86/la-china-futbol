...
class Media
{
	...
	private function validate()
	{
		...
		global $pagenow;
		if (!in_array($pagenow, ['admin.php', 'post.php', 'post-new.php', 'edit.php', 'index.php', 'widgets.php', 'site-editor.php']))
		{
			return false;
		}
	...
	public function registerAdminStyles()
	{
		...
		wp_enqueue_style('fpframework-admin-roboto');
