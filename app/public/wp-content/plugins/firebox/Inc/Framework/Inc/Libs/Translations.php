...
class Translations
{
	...
	public static function getTranslations()
	{
		return [
			...
			'FPF_PAGES' => __('Pages', 'fpf-framework'),
			...
			'FPF_PRO_MODAL_PERCENTAGE_OFF' => __('<strong>Bonus</strong>: %s lite users get <strong>20%%</strong> off regular price, automatically applied at checkout.', 'fpf-framework'),
			...
			'FPF_UNLOCK_MORE_FEATURES_WITH_PRO_READ_MORE' => __('Unlock more features by going Pro! Click to read all features provided in the Pro version.', 'fpf-framework'),
			...
			'FPF_REFERRERS_CONTAINING' => __('Referrers containing', 'fpf-framework'),
			'FPF_REFERRERS_NOT_CONTAINING' => __('Referrers not containing', 'fpf-framework'),
			'FPF_EXACT_REFERRER' => __('Exact Referrer URL', 'fpf-framework'),
			'FPF_6_MONTHS' => __('6 Months', 'fpf-framework'),
			'FPF_1_YEAR' => __('1 Year', 'fpf-framework'),
			'FPF_2_YEARS' => __('2 Years', 'fpf-framework'),
			'FPF_3_YEARS' => __('3 Years', 'fpf-framework'),
			'FPF_TODAY' => __('Today', 'fpf-framework'),
			'FPF_DATE_PERIOD' => __('Date Period', 'fpf-framework'),
			'FPF_TOP_DEVICES' => __('Top Devices', 'fpf-framework'),
			'FPF_TOP_COUNTRIES' => __('Top Countries', 'fpf-framework'),
			'FPF_TOP_REFERRERS' => __('Top Referrers', 'fpf-framework'),
			'FPF_PM' => __('PM', 'fpf-framework'),
			'FPF_AM' => __('AM', 'fpf-framework'),
			'FPF_ANALYTICS_OVERVIEW_OVERLAY_PRO_MSG1' => __('Get a quick overview of <strong>%s</strong> from your Dashboard!', 'fpf-framework'),
			...
			'FPF_YOUR_CURRENT_VERSION_IS_X' => __('Your current version is %s.', 'fpf-framework'),
			'FPF_X_VERSION_IS_AVAILABLE' => __('%s is available!', 'fpf-framework'),
			'FPF_VIEW_CHANGELOG' => __('View Changelog', 'fpf-framework'),
