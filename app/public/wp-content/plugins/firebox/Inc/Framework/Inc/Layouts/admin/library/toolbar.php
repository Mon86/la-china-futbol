        ...
        <div class="item sorting-selector-item">
            <div class="sort-wrapper">
                <div class="sorting-selected-label">
                    <span class="selected-label"><?php esc_html_e(fpframework()->_('FPF_FEATURED')); ?></span>
                ...
                <ul class="sorting-selector-items">
                    <li data-value="featured" class="selected"><?php esc_html_e(fpframework()->_('FPF_FEATURED')); ?></li>
                    <li data-value="popularity"><?php esc_html_e(fpframework()->_('FPF_POPULAR')); ?></li>
                    <li data-value="trending"><?php esc_html_e(fpframework()->_('FPF_TRENDING')); ?></li>
