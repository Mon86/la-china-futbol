...
2. Popup Templates Library consists of 240+ pre-made templates.
3. Design your popup exactly as you need it.
4. Determine the behavior of your popup.
5. Define when your popup will appear using our display conditions.
6. Set the actions your popup will perform on different events (open, close, etc...).
7. Popup Advanced Settings. Defined Custom CSS, Javascript, and more!
8. Popup Smart Tags allow you to display helpful pieces of information.
9. Popup Analytics lets you determine how a popup performs on your site.
